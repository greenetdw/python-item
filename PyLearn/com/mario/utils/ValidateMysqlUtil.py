...
#         db =  MySQLdb.connect(host='111.230.253.159',port=3306,user='root',passwd='123456',db='assacs_test',charset='utf8')
        db =  MySQLdb.connect(host='localhost',port=3306,user='root',passwd='',db='assacs',charset='utf8')
        return db
